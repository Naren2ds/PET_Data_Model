...
SOURCE_FILE = REPO_ROOT / "data" / "Pricing_Pref_ABI_RD_Men_4_26_Cliente.xlsx"
EXTRACT_SCRIPT = REPO_ROOT / "scripts" / "extract_pricing_pref_rd_inputs.py"
MAPPING_SCRIPT = REPO_ROOT / "scripts" / "data_mapping_column_rd.py"
